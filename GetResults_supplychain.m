...
cd C:\Users\nrmagliocca\'Box Sync'\'Data Drive'\model_results\SupplyChain_full_122717_slcap_sens
fnames=dir;
...
for mr=1:length(hind)   % MRUNS*EXPTRUNS
    h=strcmp(sprintf('supplychain_results_122717_%d_%d.mat',...
...
plot(2007:2014,puntarenas(1,:),'-b','LineWidth',3)
hold on
plot(2007:2014,deptflows_ts(4,7:14),'-r','LineWidth',3)
ylabel('Trafficking Volume (kg)')
xlabel('Year')
legend('CCDB Data','Model Output','Location','NorthWest')
